...
LastEditTime: 2025-12-02 20
FilePath: /fsm_ctrl/src/controllers/acados_controller/rafael_params.py
Description: 
...
quad_params = {
    ...
    'mass': 1.0,               # kg
    'L':    d,                 # m
    'Ixx':  0.003281208642,    # kg*m^2
    'Iyy':  0.00312318016824,  # kg*m^2
    'Izz':  0.00684939202037,  # kg*m^2
    'Ixy':  0.0,               # kg*m^2
    'Iyz':  0.0,               # kg*m^2 
    'Ixz':  0.0,               # kg*m^2
    ...
    'k_eta': 1.4545236059e-8,   # thrust coefficient N/(rad/s)**2
    'k_m':   5.632505e-10,      # yaw moment coefficient Nm/(rad/s)**2
